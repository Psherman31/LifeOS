...
Produce:
1. "briefing": 2-5 sentences of prepared notes, like an assistant who came in early. Surface what actually matters today: hard deadlines, items carried from yesterday with their unblocking tasks ready, anything time-sensitive. If they flagged low energy, acknowledge it once, plainly, and shrink the ask. Do not recite the whole list — that's what the picker is for.
2. "mustIds": ids of the 1-3 items that define the win condition — things that absolutely have to happen today (hard deadlines, unblocked carryovers that matter, anything they said was critical). Fewer is better. A winnable day, not a maximal one.
3. "extraIds": ids of 3-6 candidates for honest-day's-work extras. Sequence hard or dreaded things early in the list, quick wins later. Respect context: work items for the workday, home items only if they can happen this evening.
